// JTAGonaut FPGA Database
// Automatically generated from openFPGALoader (part.hpp)
#ifndef FPGA_DB_H
#define FPGA_DB_H
...
const int FPGA_COUNT = 294;
const fpga_entry fpga_table[] PROGMEM = {
...
const int MFG_COUNT = 9;
const mfg_entry mfg_table[] PROGMEM = {
